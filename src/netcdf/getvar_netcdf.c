                  ...
                  )                      /** \return TRUE on error */
{
  ...
  if(var==NULL)
  {
    ...
    for(i=0;i<nvars;i++)
    {
      ...
      if(strcmp(name,config->netcdf.lon_bnds.name) && strcmp(name,config->netcdf.lon.standard_name) && strcmp(name,config->netcdf.lat_bnds.name) && strcmp(name,config->netcdf.lat.standard_name) && strcmp(name,config->netcdf.time.name) && strcmp(name,config->netcdf.pft_name.name) && strcmp(name,config->netcdf.depth_bnds.name) && strcmp(name,config->netcdf.time_bnds.name) && strcmp(name,config->netcdf.depth.name) && strcmp(name,config->netcdf.stand_name.name))
      {
