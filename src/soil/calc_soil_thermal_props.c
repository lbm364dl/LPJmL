...
/** soil layers. It returs volumetric heat capacity, and thermal conductivity      \n**/
...
void calc_soil_thermal_props(Uniform_temp_sign uniform_temp_sign,       /**< flag to indicate if the temperatures are all positive all negative or mixed */
                             ...
                             const Real *waterc_abs,                    /**< Absolute total water content of soillayers (including ice) (mm) */
                             const Real *solc_abs,                      /**< Absolute total content of solids of soillayers (mm) */
                            ...
                            )
{
  ...
  Bool calc_frozen_values;           /* flag stating if frozen values need to be calculated */
  Bool calc_unfrozen_values;         /* flag stating if unfrozen values need to be calculated */
  ...
  for (layer = 0; layer < NSOILLAYER; ++layer)
  {
    ...
    if(with_conductivity)
    {
      ...
      {
        /* get parameters from fixed provided data */
